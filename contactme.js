...
function nuevosDatos(e) {
    ...
    if ((ofertas.length == 0) ||(email.value == "") || (company.value == "") || (phone.value == "")) {
        ...
        $("p#txt").css({"color": "red", "font-size": "30px", "margintop": "10px", "font-family": "Trebuchet MS", "font-weight": "700px", "text-align": "center"});
        ...
        $("p#txt").css({"color": "green", "font-size": "30px", "margintop": "10px", "font-family": "Trebuchet MS", "font-weight": "700px", "text-align": "center"});

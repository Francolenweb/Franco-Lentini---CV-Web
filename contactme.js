// Tener en cuenta que el diesño no esta terminado. Quiero tener bien las funciones y despues ver como armarlos bien :/
...
let nuevoUsuario = document.getElementById("nuevoUsuario");
    ...
    // Armar cambio de lenguaje (Ayuda no se como empezar. Remplazo con Dom todos los textos? o hay una forma mas facil? )
    ...
    $('#proposal').click(function() {
      ...
      // mi kriptonita: diseño. Pedir consejos a la profe para mejorar el diseño de la pag